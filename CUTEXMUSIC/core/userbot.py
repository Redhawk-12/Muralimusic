...
class Userbot(Client):
    ...
    async def start(self):
        LOGGER(__name__).info(f"sᴛᴀʀᴛɪɴɢ ᴍᴜsɪᴄ ʙᴏᴛ ᴀssɪsᴛᴀɴᴛs...")
        if config.STRING1:
            await self.one.start()
            try:
                await self.one.join_chat("ZeroXCoderZ")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("ZeroXCoderZ")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("MURALI_BOTS")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("ZeroXCoderZ")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("ZeroXCoderZ")
            except:
                pass
            assistants.append(5)
            try:
