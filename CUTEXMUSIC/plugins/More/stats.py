...
from CUTEXMUSIC.misc import SUDOERS, pymongodb
...
from CUTEXMUSIC.utils.inline.stats import (
    back_stats_buttons,
    back_stats_markup,
    get_stats_markup,
    ...
    def get_stats():
        ...
        if what in ["Tracks", "Here"]:
            for items, count in list_arranged.items():
                ...
                if items == "telegram":
                    msg += f" [ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/BACHHO_KI_DUNIYA) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                else:
...
async def overall_stats(client, CallbackQuery, _):
    ...
    text = f"""<u>❄️ **ʙᴏᴛ's sᴛᴀᴛs ᴀɴᴅ ɪɴғᴏ:**</u>

❄️ **ᴍᴏᴅᴜʟᴇs:** {mod}
❄️ **ᴄʜᴀᴛs:** {served_chats}
❄️**ᴜsᴇʀs:** {served_users} 
❄️ **ʙʟᴏᴄᴋᴇᴅ:** {blocked} 
❄️ **sᴜᴅᴏᴇʀs:** {sudoers} 
    
❄️ **ǫᴜᴇʀɪᴇs:** {total_queries} 
❄️ **ᴀssɪsᴛᴀɴᴛs:** {assistant}
❄️ **ᴀss ᴀᴜᴛᴏ ʟᴇᴀᴠᴇ:** {ass}
❄️ **ᴄʟᴇᴀɴᴍᴏᴅᴇ:** {cm} ᴍɪɴᴜᴛᴇs

❄️ **ᴅᴜʀᴀᴛɪᴏɴ ʟɪᴍɪᴛ:** {play_duration} ᴍɪɴᴜᴛᴇs
❄️ **ᴅᴏᴡɴʟᴏᴀᴅ ʟɪᴍɪᴛ:** {song} ᴍɪɴᴜᴛᴇs
❄️ **ᴩʟᴀʏʟɪsᴛ ʟɪᴍɪᴛ:** {playlist_limit}
❄️ **ᴩʟᴀʏʟɪsᴛ ᴩʟᴀʏ ʟɪᴍɪᴛ:** {fetch_playlist}"""
...
async def overall_stats(client, CallbackQuery, _):
    ...
    text = f"""❄️ **ʙᴏᴛ's sᴛᴀᴛs ᴀɴᴅ ɪɴғᴏ:**

       <u>💕 ʜᴀʀᴅᴡᴀʀᴇ</u>
❄️ **ᴍᴏᴅᴜʟᴇs:** {mod}
❄️ **ᴩʟᴀᴛғᴏʀᴍ:** {sc}
❄️ **ʀᴀᴍ:** {ram}
❄️ **ᴩʜʏsɪᴄᴀʟ ᴄᴏʀᴇs:** {p_core}
❄️ **ᴛᴏᴛᴀʟ ᴄᴏʀᴇs:** {t_core}
❄️ **ᴄᴩᴜ ғʀᴇǫᴜᴇɴᴄʏ:** {cpu_freq}

       <u>✨ sᴏғᴛᴡᴀʀᴇ</u>
❄️ **ᴩʏᴛʜᴏɴ :** {pyver.split()[0]}
❄️ **ᴩʏʀᴏɢʀᴀᴍ :** {pyrover}
❄️ **ᴩʏ-ᴛɢᴄᴀʟʟs :** {pytgver}

        <u>🌟 sᴛᴏʀᴀɢᴇ</u>
❄️ **ᴀᴠᴀɪʟᴀʙʟᴇ:** {total[:4]} GiB
❄️ **ᴜsᴇᴅ:** {used[:4]} GiB
❄️ **ғʀᴇᴇ:** {free[:4]} GiB
...
❄️ **sᴜᴅᴏᴇʀs:** {sudoers} 
      ...
      <u>☁️ ᴍᴏɴɢᴏ ᴅᴀᴛᴀʙᴀsᴇ</u>
❄️ **sɪᴢᴇ:** {datasize[:6]} ᴍʙ
❄️ **sᴛᴏʀᴀɢᴇ:** {storage} ᴍʙ
