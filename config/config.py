...
BOT_TOKEN = getenv("BOT_TOKEN", "8123997116:AAGxmlSKpRABgoQrreKcQrL69qzUmIaHhQ0")
BOT_USERNAME = getenv("BOT_USERNAME" , "KingKong_Robot")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002693180392"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "â€¢â™«â€¢â™¬â€¢ ð—›ð—”ð—ªð—ž ð— ð—¨ð—¦ð—œð—– â€¢â™¬â€¢â™«â€¢")
